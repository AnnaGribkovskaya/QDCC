...
int main(int numberOfArguments, char **argumentList)
{
    ...
    //qdotHFbasis qdot(NumberOfShellsStochastic, NumberOfShellsExact, NumberOfElectrons, homega);
    //qdot.test();
    ...
    std::cout << std::setprecision(16) << "Couple Cluster energy " << QD.iterateCCD(InitialCCDEnergy) << std::endl;
